...
namespace sat {
constexpr IntegerVariableProto::IntegerVariableProto(
...
constexpr BoolArgumentProto::BoolArgumentProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : literals_()
...
constexpr LinearExpressionProto::LinearExpressionProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
...
constexpr LinearArgumentProto::LinearArgumentProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : exprs_()
  , target_(nullptr){}
...
constexpr AllDifferentConstraintProto::AllDifferentConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : exprs_(){}
...
constexpr LinearConstraintProto::LinearConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , coeffs_()
...
constexpr ElementConstraintProto::ElementConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , index_(0)
...
constexpr IntervalConstraintProto::IntervalConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : start_(nullptr)
  , end_(nullptr)
  , size_(nullptr){}
...
constexpr NoOverlapConstraintProto::NoOverlapConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : intervals_()
...
constexpr NoOverlap2DConstraintProto::NoOverlap2DConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : x_intervals_()
...
constexpr CumulativeConstraintProto::CumulativeConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : intervals_()
  , _intervals_cached_byte_size_(0)
  , demands_()
...
constexpr ReservoirConstraintProto::ReservoirConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : time_exprs_()
  , level_changes_()
  , _level_changes_cached_byte_size_(0)
  , active_literals_()
...
constexpr CircuitConstraintProto::CircuitConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : tails_()
...
constexpr RoutesConstraintProto::RoutesConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : tails_()
  , _tails_cached_byte_size_(0)
  , heads_()
...
constexpr TableConstraintProto::TableConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , values_()
...
constexpr InverseConstraintProto::InverseConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : f_direct_()
...
constexpr AutomatonConstraintProto::AutomatonConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : final_states_()
...
constexpr ListOfVariablesProto::ListOfVariablesProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0){}
...
constexpr ConstraintProto::ConstraintProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
constexpr CpObjectiveProto::CpObjectiveProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , coeffs_()
...
constexpr FloatObjectiveProto::FloatObjectiveProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , coeffs_()
...
constexpr DecisionStrategyProto_AffineTransformation::DecisionStrategyProto_AffineTransformation(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : offset_(int64_t{0})
  , positive_coeff_(int64_t{0})
  , index_(0){}
struct DecisionStrategyProto_AffineTransformationDefaultTypeInternal {
  constexpr DecisionStrategyProto_AffineTransformationDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
constexpr DecisionStrategyProto::DecisionStrategyProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : variables_()
...
constexpr PartialVariableAssignment::PartialVariableAssignment(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : vars_()
  , _vars_cached_byte_size_(0)
  , values_()
...
constexpr SparsePermutationProto::SparsePermutationProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : support_()
...
constexpr DenseMatrixProto::DenseMatrixProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : entries_()
...
constexpr SymmetryProto::SymmetryProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : permutations_()
  , orbitopes_(){}
...
constexpr CpModelProto::CpModelProto(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : variables_()
  , constraints_()
  , search_strategy_()
...
constexpr CpSolverSolution::CpSolverSolution(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : values_()
  , _values_cached_byte_size_(0){}
...
constexpr CpSolverResponse::CpSolverResponse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : solution_()
  ...
  , solution_info_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , solve_log_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ortools_2fsat_2fcp_5fmodel_2eproto[30];
...
const uint32_t TableStruct_ortools_2fsat_2fcp_5fmodel_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::AllDifferentConstraintProto, exprs_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::ReservoirConstraintProto, time_exprs_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::ReservoirConstraintProto, level_changes_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::ReservoirConstraintProto, active_literals_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::ListOfVariablesProto, vars_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpObjectiveProto, scaling_was_exact_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpObjectiveProto, integer_offset_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpObjectiveProto, integer_scaling_factor_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::FloatObjectiveProto, vars_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::FloatObjectiveProto, coeffs_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::FloatObjectiveProto, offset_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::FloatObjectiveProto, maximize_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::DecisionStrategyProto_AffineTransformation, index_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::SparsePermutationProto, support_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::SparsePermutationProto, cycle_sizes_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::DenseMatrixProto, num_rows_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::DenseMatrixProto, num_cols_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::DenseMatrixProto, entries_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::SymmetryProto, permutations_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::SymmetryProto, orbitopes_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpModelProto, floating_point_objective_),
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpModelProto, symmetry_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverSolution, values_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, additional_solutions_),
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, integer_objective_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, inner_objective_lower_bound_),
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, num_restarts_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, num_lp_iterations_),
  ...
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, gap_integral_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, solution_info_),
  PROTOBUF_FIELD_OFFSET(::operations_research::sat::CpSolverResponse, solve_log_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 204, -1, -1, sizeof(::operations_research::sat::FloatObjectiveProto)},
  { 214, -1, -1, sizeof(::operations_research::sat::DecisionStrategyProto_AffineTransformation)},
  { 223, -1, -1, sizeof(::operations_research::sat::DecisionStrategyProto)},
  { 233, -1, -1, sizeof(::operations_research::sat::PartialVariableAssignment)},
  { 241, -1, -1, sizeof(::operations_research::sat::SparsePermutationProto)},
  { 249, -1, -1, sizeof(::operations_research::sat::DenseMatrixProto)},
  { 258, -1, -1, sizeof(::operations_research::sat::SymmetryProto)},
  { 266, -1, -1, sizeof(::operations_research::sat::CpModelProto)},
  { 281, -1, -1, sizeof(::operations_research::sat::CpSolverSolution)},
  { 288, -1, -1, sizeof(::operations_research::sat::CpSolverResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_ListOfVariablesProto_default_instance_),
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_FloatObjectiveProto_default_instance_),
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_SparsePermutationProto_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_DenseMatrixProto_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_SymmetryProto_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_CpModelProto_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::operations_research::sat::_CpSolverSolution_default_instance_),
...
const char descriptor_table_protodef_ortools_2fsat_2fcp_5fmodel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "xpressionProto\022\025\n\rlevel_changes\030\004 \003(\003\022\027\n"
  "\017active_literals\030\005 \003(\005\"H\n\026CircuitConstra"
  ...
  "als\030\003 \003(\005\022\017\n\007demands\030\004 \003(\005\022\020\n\010capacity\030\005"
  " \001(\003\"E\n\024TableConstraintProto\022\014\n\004vars\030\001 \003"
  "(\005\022\016\n\006values\030\002 \003(\003\022\017\n\007negated\030\003 \001(\010\"=\n\026I"
  "nverseConstraintProto\022\020\n\010f_direct\030\001 \003(\005\022"
  "\021\n\tf_inverse\030\002 \003(\005\"\242\001\n\030AutomatonConstrai"
  "ntProto\022\026\n\016starting_state\030\002 \001(\003\022\024\n\014final"
  "_states\030\003 \003(\003\022\027\n\017transition_tail\030\004 \003(\003\022\027"
  "\n\017transition_head\030\005 \003(\003\022\030\n\020transition_la"
  "bel\030\006 \003(\003\022\014\n\004vars\030\007 \003(\005\"$\n\024ListOfVariabl"
  "esProto\022\014\n\004vars\030\001 \003(\005\"\360\014\n\017ConstraintProt"
  "o\022\014\n\004name\030\001 \001(\t\022\033\n\023enforcement_literal\030\002"
  " \003(\005\022=\n\007bool_or\030\003 \001(\0132*.operations_resea"
  "rch.sat.BoolArgumentProtoH\000\022>\n\010bool_and\030"
  "\004 \001(\0132*.operations_research.sat.BoolArgu"
  "mentProtoH\000\022A\n\013at_most_one\030\032 \001(\0132*.opera"
  "tions_research.sat.BoolArgumentProtoH\000\022A"
  "\n\013exactly_one\030\035 \001(\0132*.operations_researc"
  "h.sat.BoolArgumentProtoH\000\022>\n\010bool_xor\030\005 "
  "\001(\0132*.operations_research.sat.BoolArgume"
  "ntProtoH\000\022\?\n\007int_div\030\007 \001(\0132,.operations_"
  "research.sat.LinearArgumentProtoH\000\022\?\n\007in"
  "t_mod\030\010 \001(\0132,.operations_research.sat.Li"
  "nearArgumentProtoH\000\022@\n\010int_prod\030\013 \001(\0132,."
  "operations_research.sat.LinearArgumentPr"
  "otoH\000\022\?\n\007lin_max\030\033 \001(\0132,.operations_rese"
  "arch.sat.LinearArgumentProtoH\000\022@\n\006linear"
  "\030\014 \001(\0132..operations_research.sat.LinearC"
  "onstraintProtoH\000\022H\n\010all_diff\030\r \001(\01324.ope"
  "rations_research.sat.AllDifferentConstra"
  "intProtoH\000\022B\n\007element\030\016 \001(\0132/.operations"
  "_research.sat.ElementConstraintProtoH\000\022B"
  "\n\007circuit\030\017 \001(\0132/.operations_research.sa"
  "t.CircuitConstraintProtoH\000\022@\n\006routes\030\027 \001"
  "(\0132..operations_research.sat.RoutesConst"
  "raintProtoH\000\022>\n\005table\030\020 \001(\0132-.operations"
  "_research.sat.TableConstraintProtoH\000\022F\n\t"
  "automaton\030\021 \001(\01321.operations_research.sa"
  "t.AutomatonConstraintProtoH\000\022B\n\007inverse\030"
  "\022 \001(\0132/.operations_research.sat.InverseC"
  "onstraintProtoH\000\022F\n\treservoir\030\030 \001(\01321.op"
  "erations_research.sat.ReservoirConstrain"
  "tProtoH\000\022D\n\010interval\030\023 \001(\01320.operations_"
  "research.sat.IntervalConstraintProtoH\000\022G"
  "\n\nno_overlap\030\024 \001(\01321.operations_research"
  ".sat.NoOverlapConstraintProtoH\000\022L\n\rno_ov"
  "erlap_2d\030\025 \001(\01323.operations_research.sat"
  ".NoOverlap2DConstraintProtoH\000\022H\n\ncumulat"
  "ive\030\026 \001(\01322.operations_research.sat.Cumu"
  "lativeConstraintProtoH\000\022I\n\020dummy_constra"
  "int\030\036 \001(\0132-.operations_research.sat.List"
  "OfVariablesProtoH\000B\014\n\nconstraint\"\273\001\n\020CpO"
  "bjectiveProto\022\014\n\004vars\030\001 \003(\005\022\016\n\006coeffs\030\004 "
  ...
  "r_scaling_factor\030\010 \001(\003\"U\n\023FloatObjective"
  "Proto\022\014\n\004vars\030\001 \003(\005\022\016\n\006coeffs\030\002 \003(\001\022\016\n\006o"
  "ffset\030\003 \001(\001\022\020\n\010maximize\030\004 \001(\010\"\327\005\n\025Decisi"
  "onStrategyProto\022\021\n\tvariables\030\001 \003(\005\022m\n\033va"
  "riable_selection_strategy\030\002 \001(\0162H.operat"
  "ions_research.sat.DecisionStrategyProto."
  "VariableSelectionStrategy\022i\n\031domain_redu"
  "ction_strategy\030\003 \001(\0162F.operations_resear"
  "ch.sat.DecisionStrategyProto.DomainReduc"
  "tionStrategy\022\\\n\017transformations\030\004 \003(\0132C."
  "operations_research.sat.DecisionStrategy"
  "Proto.AffineTransformation\032M\n\024AffineTran"
  "sformation\022\r\n\005index\030\001 \001(\005\022\016\n\006offset\030\002 \001("
  "\003\022\026\n\016positive_coeff\030\003 \001(\003\"\224\001\n\031VariableSe"
  "lectionStrategy\022\020\n\014CHOOSE_FIRST\020\000\022\025\n\021CHO"
  "OSE_LOWEST_MIN\020\001\022\026\n\022CHOOSE_HIGHEST_MAX\020\002"
  "\022\032\n\026CHOOSE_MIN_DOMAIN_SIZE\020\003\022\032\n\026CHOOSE_M"
  "AX_DOMAIN_SIZE\020\004\"\214\001\n\027DomainReductionStra"
  "tegy\022\024\n\020SELECT_MIN_VALUE\020\000\022\024\n\020SELECT_MAX"
  "_VALUE\020\001\022\025\n\021SELECT_LOWER_HALF\020\002\022\025\n\021SELEC"
  "T_UPPER_HALF\020\003\022\027\n\023SELECT_MEDIAN_VALUE\020\004\""
  ...
  "erations_research.sat.SparsePermutationP"
  "roto\022<\n\torbitopes\030\002 \003(\0132).operations_res"
  "earch.sat.DenseMatrixProto\"\216\004\n\014CpModelPr"
  "oto\022\014\n\004name\030\001 \001(\t\022@\n\tvariables\030\002 \003(\0132-.o"
  "perations_research.sat.IntegerVariablePr"
  "oto\022=\n\013constraints\030\003 \003(\0132(.operations_re"
  "search.sat.ConstraintProto\022<\n\tobjective\030"
  "\004 \001(\0132).operations_research.sat.CpObject"
  "iveProto\022N\n\030floating_point_objective\030\t \001"
  "(\0132,.operations_research.sat.FloatObject"
  "iveProto\022G\n\017search_strategy\030\005 \003(\0132..oper"
  "ations_research.sat.DecisionStrategyProt"
  "o\022I\n\rsolution_hint\030\006 \001(\01322.operations_re"
  "search.sat.PartialVariableAssignment\022\023\n\013"
  "assumptions\030\007 \003(\005\0228\n\010symmetry\030\010 \001(\0132&.op"
  "erations_research.sat.SymmetryProto\"\"\n\020C"
  "pSolverSolution\022\016\n\006values\030\001 \003(\003\"\377\005\n\020CpSo"
  "lverResponse\0227\n\006status\030\001 \001(\0162\'.operation"
  "s_research.sat.CpSolverStatus\022\020\n\010solutio"
  "n\030\002 \003(\003\022\027\n\017objective_value\030\003 \001(\001\022\034\n\024best"
  "_objective_bound\030\004 \001(\001\022G\n\024additional_sol"
  "utions\030\033 \003(\0132).operations_research.sat.C"
  "pSolverSolution\022J\n\023tightened_variables\030\025"
  " \003(\0132-.operations_research.sat.IntegerVa"
  "riableProto\0220\n(sufficient_assumptions_fo"
  "r_infeasibility\030\027 \003(\005\022D\n\021integer_objecti"
  "ve\030\034 \001(\0132).operations_research.sat.CpObj"
  "ectiveProto\022#\n\033inner_objective_lower_bou"
  "nd\030\035 \001(\003\022\024\n\014num_booleans\030\n \001(\003\022\025\n\rnum_co"
  "nflicts\030\013 \001(\003\022\024\n\014num_branches\030\014 \001(\003\022\037\n\027n"
  "um_binary_propagations\030\r \001(\003\022 \n\030num_inte"
  "ger_propagations\030\016 \001(\003\022\024\n\014num_restarts\030\030"
  " \001(\003\022\031\n\021num_lp_iterations\030\031 \001(\003\022\021\n\twall_"
  "time\030\017 \001(\001\022\021\n\tuser_time\030\020 \001(\001\022\032\n\022determi"
  "nistic_time\030\021 \001(\001\022\024\n\014gap_integral\030\026 \001(\001\022"
  "\025\n\rsolution_info\030\024 \001(\t\022\021\n\tsolve_log\030\032 \001("
  "\t*[\n\016CpSolverStatus\022\013\n\007UNKNOWN\020\000\022\021\n\rMODE"
  "L_INVALID\020\001\022\014\n\010FEASIBLE\020\002\022\016\n\nINFEASIBLE\020"
  "\003\022\013\n\007OPTIMAL\020\004B@\n\026com.google.ortools.sat"
  "B\017CpModelProtobufP\001\252\002\022Google.OrTools.Sat"
  "b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ortools_2fsat_2fcp_5fmodel_2eproto = {
  ...
  file_level_metadata_ortools_2fsat_2fcp_5fmodel_2eproto, file_level_enum_descriptors_ortools_2fsat_2fcp_5fmodel_2eproto, file_level_service_descriptors_ortools_2fsat_2fcp_5fmodel_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ortools_2fsat_2fcp_5fmodel_2eproto_getter() {
  return &descriptor_table_ortools_2fsat_2fcp_5fmodel_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ortools_2fsat_2fcp_5fmodel_2eproto(&descriptor_table_ortools_2fsat_2fcp_5fmodel_2eproto);
namespace operations_research {
namespace sat {
...
void IntegerVariableProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<IntegerVariableProto *>(to)->MergeFrom(
      static_cast<const IntegerVariableProto &>(from));
}
...
void BoolArgumentProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<BoolArgumentProto *>(to)->MergeFrom(
      static_cast<const BoolArgumentProto &>(from));
}
...
void LinearExpressionProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LinearExpressionProto *>(to)->MergeFrom(
      static_cast<const LinearExpressionProto &>(from));
}
...
void LinearArgumentProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LinearArgumentProto *>(to)->MergeFrom(
      static_cast<const LinearArgumentProto &>(from));
}
...
void AllDifferentConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<AllDifferentConstraintProto *>(to)->MergeFrom(
      static_cast<const AllDifferentConstraintProto &>(from));
}
...
void LinearConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LinearConstraintProto *>(to)->MergeFrom(
      static_cast<const LinearConstraintProto &>(from));
}
...
void ElementConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ElementConstraintProto *>(to)->MergeFrom(
      static_cast<const ElementConstraintProto &>(from));
}
...
IntervalConstraintProto::IntervalConstraintProto(const IntervalConstraintProto& from)
  ...
  if (from._internal_has_start()) {
    start_ = new ::operations_research::sat::LinearExpressionProto(*from.start_);
  } else {
    start_ = nullptr;
  }
  if (from._internal_has_end()) {
    end_ = new ::operations_research::sat::LinearExpressionProto(*from.end_);
  } else {
    end_ = nullptr;
  }
  if (from._internal_has_size()) {
    size_ = new ::operations_research::sat::LinearExpressionProto(*from.size_);
  } else {
    size_ = nullptr;
  }
...
void IntervalConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<IntervalConstraintProto *>(to)->MergeFrom(
      static_cast<const IntervalConstraintProto &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.IntervalConstraintProto)
  ...
  if (from._internal_has_start()) {
    _internal_mutable_start()->::operations_research::sat::LinearExpressionProto::MergeFrom(from._internal_start());
  }
  if (from._internal_has_end()) {
    _internal_mutable_end()->::operations_research::sat::LinearExpressionProto::MergeFrom(from._internal_end());
  }
  if (from._internal_has_size()) {
    _internal_mutable_size()->::operations_research::sat::LinearExpressionProto::MergeFrom(from._internal_size());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void NoOverlapConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<NoOverlapConstraintProto *>(to)->MergeFrom(
      static_cast<const NoOverlapConstraintProto &>(from));
}
...
void NoOverlap2DConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<NoOverlap2DConstraintProto *>(to)->MergeFrom(
      static_cast<const NoOverlap2DConstraintProto &>(from));
}
...
CumulativeConstraintProto::CumulativeConstraintProto(const CumulativeConstraintProto& from)
  ...
  if (from._internal_has_capacity()) {
    capacity_ = new ::operations_research::sat::LinearExpressionProto(*from.capacity_);
  } else {
    capacity_ = nullptr;
  }
...
uint8_t* CumulativeConstraintProto::_InternalSerialize(
  ...
  // repeated .operations_research.sat.LinearExpressionProto demands = 3;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_demands_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, this->_internal_demands(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.CumulativeConstraintProto)
  ...
  for (const auto& msg : this->demands_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void CumulativeConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CumulativeConstraintProto *>(to)->MergeFrom(
      static_cast<const CumulativeConstraintProto &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.CumulativeConstraintProto)
  ...
  if (from._internal_has_capacity()) {
    _internal_mutable_capacity()->::operations_research::sat::LinearExpressionProto::MergeFrom(from._internal_capacity());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
ReservoirConstraintProto::ReservoirConstraintProto(const ReservoirConstraintProto& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      time_exprs_(from.time_exprs_),
      level_changes_(from.level_changes_),
      active_literals_(from.active_literals_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&min_level_) - reinterpret_cast<char*>(this)),
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          goto handle_unusual;
        continue;
      // repeated int64 level_changes = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt64Parser(_internal_mutable_level_changes(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 32) {
          _internal_add_level_changes(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ReservoirConstraintProto::_InternalSerialize(
  ...
  // repeated .operations_research.sat.LinearExpressionProto time_exprs = 3;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_time_exprs_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, this->_internal_time_exprs(i), target, stream);
  }

  // repeated int64 level_changes = 4;
  {
    int byte_size = _level_changes_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt64Packed(
          4, _internal_level_changes(), byte_size, target);
    }
  }

  // repeated int32 active_literals = 5;
  {
    int byte_size = _active_literals_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.ReservoirConstraintProto)
  ...
  for (const auto& msg : this->time_exprs_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  // repeated int64 level_changes = 4;
  {
    ...
    int cached_size = ::PROTOBUF_NAMESPACE_ID::internal::ToCachedSize(data_size);
    _level_changes_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  {
    size_t data_size = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      Int32Size(this->active_literals_);
    if (data_size > 0) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
            static_cast<int32_t>(data_size));
    ...
    int cached_size = ::PROTOBUF_NAMESPACE_ID::internal::ToCachedSize(data_size);
    _active_literals_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // int64 min_level = 1;
  if (this->_internal_min_level() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_min_level());
  }

  // int64 max_level = 2;
  if (this->_internal_max_level() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_max_level());
  }
...
void ReservoirConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ReservoirConstraintProto *>(to)->MergeFrom(
      static_cast<const ReservoirConstraintProto &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.ReservoirConstraintProto)
  ...
  time_exprs_.MergeFrom(from.time_exprs_);
  level_changes_.MergeFrom(from.level_changes_);
  active_literals_.MergeFrom(from.active_literals_);
...
void ReservoirConstraintProto::InternalSwap(ReservoirConstraintProto* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  time_exprs_.InternalSwap(&other->time_exprs_);
  level_changes_.InternalSwap(&other->level_changes_);
  active_literals_.InternalSwap(&other->active_literals_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
void CircuitConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CircuitConstraintProto *>(to)->MergeFrom(
      static_cast<const CircuitConstraintProto &>(from));
}
...
void RoutesConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<RoutesConstraintProto *>(to)->MergeFrom(
      static_cast<const RoutesConstraintProto &>(from));
}
...
void TableConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TableConstraintProto *>(to)->MergeFrom(
      static_cast<const TableConstraintProto &>(from));
}
...
void InverseConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<InverseConstraintProto *>(to)->MergeFrom(
      static_cast<const InverseConstraintProto &>(from));
}
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.AutomatonConstraintProto)
  ...
  // int64 starting_state = 2;
  if (this->_internal_starting_state() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_starting_state());
  }
...
void AutomatonConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<AutomatonConstraintProto *>(to)->MergeFrom(
      static_cast<const AutomatonConstraintProto &>(from));
}
...
void ListOfVariablesProto::ArenaDtor(void* object) {
  ListOfVariablesProto* _this = reinterpret_cast< ListOfVariablesProto* >(object);
  (void)_this;
}
void ListOfVariablesProto::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* ListOfVariablesProto::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
void ListOfVariablesProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ListOfVariablesProto *>(to)->MergeFrom(
      static_cast<const ListOfVariablesProto &>(from));
}


void ListOfVariablesProto::MergeFrom(const ListOfVariablesProto& from) {
...
ConstraintProto::_Internal::exactly_one(const ConstraintProto* msg) {
  return *msg->constraint_.exactly_one_;
}
const ::operations_research::sat::BoolArgumentProto&
...
ConstraintProto::_Internal::dummy_constraint(const ConstraintProto* msg) {
  return *msg->constraint_.dummy_constraint_;
}
void ConstraintProto::set_allocated_bool_or(::operations_research::sat::BoolArgumentProto* bool_or) {
  ...
  if (bool_or) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BoolArgumentProto>::GetOwningArena(bool_or);
...
void ConstraintProto::set_allocated_bool_and(::operations_research::sat::BoolArgumentProto* bool_and) {
  ...
  if (bool_and) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BoolArgumentProto>::GetOwningArena(bool_and);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_at_most_one(::operations_research::sat::BoolArgumentProto* at_most_one) {
  ...
  if (at_most_one) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BoolArgumentProto>::GetOwningArena(at_most_one);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_exactly_one(::operations_research::sat::BoolArgumentProto* exactly_one) {
  ...
  if (exactly_one) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BoolArgumentProto>::GetOwningArena(exactly_one);
    if (message_arena != submessage_arena) {
      exactly_one = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, exactly_one, submessage_arena);
    }
    set_has_exactly_one();
    constraint_.exactly_one_ = exactly_one;
  }
...
void ConstraintProto::set_allocated_bool_xor(::operations_research::sat::BoolArgumentProto* bool_xor) {
  ...
  if (bool_xor) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BoolArgumentProto>::GetOwningArena(bool_xor);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_int_div(::operations_research::sat::LinearArgumentProto* int_div) {
  ...
  if (int_div) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearArgumentProto>::GetOwningArena(int_div);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_int_mod(::operations_research::sat::LinearArgumentProto* int_mod) {
  ...
  if (int_mod) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearArgumentProto>::GetOwningArena(int_mod);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_int_prod(::operations_research::sat::LinearArgumentProto* int_prod) {
  ...
  if (int_prod) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearArgumentProto>::GetOwningArena(int_prod);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_lin_max(::operations_research::sat::LinearArgumentProto* lin_max) {
  ...
  if (lin_max) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearArgumentProto>::GetOwningArena(lin_max);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_linear(::operations_research::sat::LinearConstraintProto* linear) {
  ...
  if (linear) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearConstraintProto>::GetOwningArena(linear);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_all_diff(::operations_research::sat::AllDifferentConstraintProto* all_diff) {
  ...
  if (all_diff) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::AllDifferentConstraintProto>::GetOwningArena(all_diff);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_element(::operations_research::sat::ElementConstraintProto* element) {
  ...
  if (element) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::ElementConstraintProto>::GetOwningArena(element);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_circuit(::operations_research::sat::CircuitConstraintProto* circuit) {
  ...
  if (circuit) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::CircuitConstraintProto>::GetOwningArena(circuit);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_routes(::operations_research::sat::RoutesConstraintProto* routes) {
  ...
  if (routes) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::RoutesConstraintProto>::GetOwningArena(routes);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_table(::operations_research::sat::TableConstraintProto* table) {
  ...
  if (table) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::TableConstraintProto>::GetOwningArena(table);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_automaton(::operations_research::sat::AutomatonConstraintProto* automaton) {
  ...
  if (automaton) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::AutomatonConstraintProto>::GetOwningArena(automaton);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_inverse(::operations_research::sat::InverseConstraintProto* inverse) {
  ...
  if (inverse) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::InverseConstraintProto>::GetOwningArena(inverse);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_reservoir(::operations_research::sat::ReservoirConstraintProto* reservoir) {
  ...
  if (reservoir) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::ReservoirConstraintProto>::GetOwningArena(reservoir);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_interval(::operations_research::sat::IntervalConstraintProto* interval) {
  ...
  if (interval) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::IntervalConstraintProto>::GetOwningArena(interval);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_no_overlap(::operations_research::sat::NoOverlapConstraintProto* no_overlap) {
  ...
  if (no_overlap) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::NoOverlapConstraintProto>::GetOwningArena(no_overlap);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_no_overlap_2d(::operations_research::sat::NoOverlap2DConstraintProto* no_overlap_2d) {
  ...
  if (no_overlap_2d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::NoOverlap2DConstraintProto>::GetOwningArena(no_overlap_2d);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_cumulative(::operations_research::sat::CumulativeConstraintProto* cumulative) {
  ...
  if (cumulative) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::CumulativeConstraintProto>::GetOwningArena(cumulative);
    if (message_arena != submessage_arena) {
...
void ConstraintProto::set_allocated_dummy_constraint(::operations_research::sat::ListOfVariablesProto* dummy_constraint) {
  ...
  if (dummy_constraint) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::ListOfVariablesProto>::GetOwningArena(dummy_constraint);
    if (message_arena != submessage_arena) {
    ...
    constraint_.dummy_constraint_ = dummy_constraint;
  }
...
ConstraintProto::ConstraintProto(const ConstraintProto& from)
  ...
  switch (from.constraint_case()) {
    ...
    case kExactlyOne: {
      _internal_mutable_exactly_one()->::operations_research::sat::BoolArgumentProto::MergeFrom(from._internal_exactly_one());
      break;
    }
    case kBoolXor: {
    ...
    case kIntDiv: {
      _internal_mutable_int_div()->::operations_research::sat::LinearArgumentProto::MergeFrom(from._internal_int_div());
      break;
    }
    case kIntMod: {
      _internal_mutable_int_mod()->::operations_research::sat::LinearArgumentProto::MergeFrom(from._internal_int_mod());
      break;
    }
    case kIntProd: {
      _internal_mutable_int_prod()->::operations_research::sat::LinearArgumentProto::MergeFrom(from._internal_int_prod());
      break;
    }
    case kLinMax: {
    ...
    case kDummyConstraint: {
      _internal_mutable_dummy_constraint()->::operations_research::sat::ListOfVariablesProto::MergeFrom(from._internal_dummy_constraint());
      break;
    }
...
// @@protoc_insertion_point(one_of_clear_start:operations_research.sat.ConstraintProto)
  switch (constraint_case()) {
    ...
    case kExactlyOne: {
      if (GetArenaForAllocation() == nullptr) {
        delete constraint_.exactly_one_;
      }
      break;
    }
    case kBoolXor: {
    ...
    case kDummyConstraint: {
      if (GetArenaForAllocation() == nullptr) {
        delete constraint_.dummy_constraint_;
      }
      break;
    }
    case CONSTRAINT_NOT_SET: {
...
uint8_t* ConstraintProto::_InternalSerialize(
  ...
  if (_internal_has_exactly_one()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        29, _Internal::exactly_one(this), target, stream);
  }
  ...
  if (_internal_has_dummy_constraint()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        30, _Internal::dummy_constraint(this), target, stream);
  }
...
void ConstraintProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ConstraintProto *>(to)->MergeFrom(
      static_cast<const ConstraintProto &>(from));
}
...
CpObjectiveProto::CpObjectiveProto(const CpObjectiveProto& from)
  ...
  ::memcpy(&offset_, &from.offset_,
    static_cast<size_t>(reinterpret_cast<char*>(&scaling_was_exact_) -
    reinterpret_cast<char*>(&offset_)) + sizeof(scaling_was_exact_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&scaling_was_exact_) -
    reinterpret_cast<char*>(&offset_)) + sizeof(scaling_was_exact_));
}
...
// @@protoc_insertion_point(message_clear_start:operations_research.sat.CpObjectiveProto)
  ...
  ::memset(&offset_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&scaling_was_exact_) -
      reinterpret_cast<char*>(&offset_)) + sizeof(scaling_was_exact_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          scaling_was_exact_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          integer_offset_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          integer_scaling_factor_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CpObjectiveProto::_InternalSerialize(
  ...
  if (this->_internal_scaling_was_exact() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(6, this->_internal_scaling_was_exact(), target);
  }

  // int64 integer_offset = 7;
  if (this->_internal_integer_offset() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(7, this->_internal_integer_offset(), target);
  }

  // int64 integer_scaling_factor = 8;
  if (this->_internal_integer_scaling_factor() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(8, this->_internal_integer_scaling_factor(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.CpObjectiveProto)
  ...
  // int64 integer_offset = 7;
  if (this->_internal_integer_offset() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_integer_offset());
  }

  // int64 integer_scaling_factor = 8;
  if (this->_internal_integer_scaling_factor() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_integer_scaling_factor());
  }
...
void CpObjectiveProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CpObjectiveProto *>(to)->MergeFrom(
      static_cast<const CpObjectiveProto &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.CpObjectiveProto)
  ...
  if (from._internal_integer_offset() != 0) {
    _internal_set_integer_offset(from._internal_integer_offset());
  }
  if (from._internal_integer_scaling_factor() != 0) {
    _internal_set_integer_scaling_factor(from._internal_integer_scaling_factor());
  }
  if (from._internal_scaling_was_exact() != 0) {
    _internal_set_scaling_was_exact(from._internal_scaling_was_exact());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CpObjectiveProto::InternalSwap(CpObjectiveProto* other) {
  ...
  domain_.InternalSwap(&other->domain_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CpObjectiveProto, scaling_was_exact_)
...
FloatObjectiveProto::FloatObjectiveProto(const FloatObjectiveProto& from)
  ...
  ::memcpy(&offset_, &from.offset_,
    ...
    reinterpret_cast<char*>(&offset_)) + sizeof(maximize_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&offset_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&maximize_) -
    reinterpret_cast<char*>(&offset_)) + sizeof(maximize_));
}
...
void FloatObjectiveProto::ArenaDtor(void* object) {
  FloatObjectiveProto* _this = reinterpret_cast< FloatObjectiveProto* >(object);
  (void)_this;
}
void FloatObjectiveProto::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* FloatObjectiveProto::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
uint8_t* FloatObjectiveProto::_InternalSerialize(
  ...
  if (this->_internal_maximize() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(4, this->_internal_maximize(), target);
  }
...
void FloatObjectiveProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<FloatObjectiveProto *>(to)->MergeFrom(
      static_cast<const FloatObjectiveProto &>(from));
}


void FloatObjectiveProto::MergeFrom(const FloatObjectiveProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.FloatObjectiveProto)
  ...
  if (from._internal_maximize() != 0) {
    _internal_set_maximize(from._internal_maximize());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void FloatObjectiveProto::InternalSwap(FloatObjectiveProto* other) {
  ...
  coeffs_.InternalSwap(&other->coeffs_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FloatObjectiveProto, maximize_)
      + sizeof(FloatObjectiveProto::maximize_)
      - PROTOBUF_FIELD_OFFSET(FloatObjectiveProto, offset_)>(
          reinterpret_cast<char*>(&offset_),
          reinterpret_cast<char*>(&other->offset_));
}
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.DecisionStrategyProto.AffineTransformation)
  ...
  // int64 positive_coeff = 3;
  if (this->_internal_positive_coeff() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_positive_coeff());
  }
...
void DecisionStrategyProto_AffineTransformation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<DecisionStrategyProto_AffineTransformation *>(to)->MergeFrom(
      static_cast<const DecisionStrategyProto_AffineTransformation &>(from));
}
...
void DecisionStrategyProto_AffineTransformation::InternalSwap(DecisionStrategyProto_AffineTransformation* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DecisionStrategyProto_AffineTransformation, index_)
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&variable_selection_strategy_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&domain_reduction_strategy_) -
    reinterpret_cast<char*>(&variable_selection_strategy_)) + sizeof(domain_reduction_strategy_));
}
...
void DecisionStrategyProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<DecisionStrategyProto *>(to)->MergeFrom(
      static_cast<const DecisionStrategyProto &>(from));
}
...
void PartialVariableAssignment::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<PartialVariableAssignment *>(to)->MergeFrom(
      static_cast<const PartialVariableAssignment &>(from));
}
...
SparsePermutationProto::SparsePermutationProto(const SparsePermutationProto& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      ...
      cycle_sizes_(from.cycle_sizes_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void SparsePermutationProto::ArenaDtor(void* object) {
  SparsePermutationProto* _this = reinterpret_cast< SparsePermutationProto* >(object);
  (void)_this;
}
void SparsePermutationProto::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* SparsePermutationProto::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
uint8_t* SparsePermutationProto::_InternalSerialize(
  ...
  // repeated int32 support = 1;
  {
    int byte_size = _support_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
  ...
  // repeated int32 cycle_sizes = 2;
  {
    int byte_size = _cycle_sizes_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.SparsePermutationProto)
  ...
  // repeated int32 support = 1;
  {
    ...
    int cached_size = ::PROTOBUF_NAMESPACE_ID::internal::ToCachedSize(data_size);
    _support_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // repeated int32 cycle_sizes = 2;
  {
    ...
    int cached_size = ::PROTOBUF_NAMESPACE_ID::internal::ToCachedSize(data_size);
    _cycle_sizes_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
...
void SparsePermutationProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<SparsePermutationProto *>(to)->MergeFrom(
      static_cast<const SparsePermutationProto &>(from));
}


void SparsePermutationProto::MergeFrom(const SparsePermutationProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.SparsePermutationProto)
  ...
  cycle_sizes_.MergeFrom(from.cycle_sizes_);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void SparsePermutationProto::InternalSwap(SparsePermutationProto* other) {
  ...
  cycle_sizes_.InternalSwap(&other->cycle_sizes_);
}
...
DenseMatrixProto::DenseMatrixProto(const DenseMatrixProto& from)
  ...
  ::memcpy(&num_rows_, &from.num_rows_,
    static_cast<size_t>(reinterpret_cast<char*>(&num_cols_) -
    reinterpret_cast<char*>(&num_rows_)) + sizeof(num_cols_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&num_cols_) -
    reinterpret_cast<char*>(&num_rows_)) + sizeof(num_cols_));
}
...
void DenseMatrixProto::ArenaDtor(void* object) {
  DenseMatrixProto* _this = reinterpret_cast< DenseMatrixProto* >(object);
  (void)_this;
}
void DenseMatrixProto::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:operations_research.sat.DenseMatrixProto)
  ...
  ::memset(&num_rows_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&num_cols_) -
      reinterpret_cast<char*>(&num_rows_)) + sizeof(num_cols_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* DenseMatrixProto::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          num_cols_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* DenseMatrixProto::_InternalSerialize(
  ...
  if (this->_internal_num_cols() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_num_cols(), target);
  }

  // repeated int32 entries = 3;
  {
    int byte_size = _entries_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.DenseMatrixProto)
  ...
  // repeated int32 entries = 3;
  {
    ...
    int cached_size = ::PROTOBUF_NAMESPACE_ID::internal::ToCachedSize(data_size);
    _entries_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
  ...
  // int32 num_cols = 2;
  if (this->_internal_num_cols() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_num_cols());
  }
...
void DenseMatrixProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<DenseMatrixProto *>(to)->MergeFrom(
      static_cast<const DenseMatrixProto &>(from));
}


void DenseMatrixProto::MergeFrom(const DenseMatrixProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.DenseMatrixProto)
  ...
  if (from._internal_num_cols() != 0) {
    _internal_set_num_cols(from._internal_num_cols());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void DenseMatrixProto::InternalSwap(DenseMatrixProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DenseMatrixProto, num_cols_)
      + sizeof(DenseMatrixProto::num_cols_)
      - PROTOBUF_FIELD_OFFSET(DenseMatrixProto, num_rows_)>(
...
SymmetryProto::SymmetryProto(const SymmetryProto& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      permutations_(from.permutations_),
      orbitopes_(from.orbitopes_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void SymmetryProto::ArenaDtor(void* object) {
  SymmetryProto* _this = reinterpret_cast< SymmetryProto* >(object);
  (void)_this;
}
void SymmetryProto::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* SymmetryProto::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
uint8_t* SymmetryProto::_InternalSerialize(
  ...
  // repeated .operations_research.sat.SparsePermutationProto permutations = 1;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_permutations_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, this->_internal_permutations(i), target, stream);
  }

  // repeated .operations_research.sat.DenseMatrixProto orbitopes = 2;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_orbitopes_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_orbitopes(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.SymmetryProto)
  ...
  for (const auto& msg : this->permutations_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  for (const auto& msg : this->orbitopes_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void SymmetryProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<SymmetryProto *>(to)->MergeFrom(
      static_cast<const SymmetryProto &>(from));
}


void SymmetryProto::MergeFrom(const SymmetryProto& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.SymmetryProto)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  permutations_.MergeFrom(from.permutations_);
  orbitopes_.MergeFrom(from.orbitopes_);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void SymmetryProto::InternalSwap(SymmetryProto* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  permutations_.InternalSwap(&other->permutations_);
  orbitopes_.InternalSwap(&other->orbitopes_);
}
...
CpModelProto::_Internal::floating_point_objective(const CpModelProto* msg) {
  return *msg->floating_point_objective_;
}
...
CpModelProto::CpModelProto(const CpModelProto& from)
  ...
  if (from._internal_has_symmetry()) {
    symmetry_ = new ::operations_research::sat::SymmetryProto(*from.symmetry_);
  } else {
    symmetry_ = nullptr;
  }
  if (from._internal_has_floating_point_objective()) {
    floating_point_objective_ = new ::operations_research::sat::FloatObjectiveProto(*from.floating_point_objective_);
  } else {
    floating_point_objective_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&floating_point_objective_) -
    reinterpret_cast<char*>(&objective_)) + sizeof(floating_point_objective_));
}
...
inline void CpModelProto::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete symmetry_;
  if (this != internal_default_instance()) delete floating_point_objective_;
}
...
// @@protoc_insertion_point(message_clear_start:operations_research.sat.CpModelProto)
  ...
  objective_ = nullptr;
  if (GetArenaForAllocation() == nullptr && solution_hint_ != nullptr) {
    delete solution_hint_;
  }
  solution_hint_ = nullptr;
  if (GetArenaForAllocation() == nullptr && symmetry_ != nullptr) {
    delete symmetry_;
  }
  symmetry_ = nullptr;
  if (GetArenaForAllocation() == nullptr && floating_point_objective_ != nullptr) {
    delete floating_point_objective_;
  }
  floating_point_objective_ = nullptr;
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
uint8_t* CpModelProto::_InternalSerialize(
  ...
  if (this->_internal_has_symmetry()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        8, _Internal::symmetry(this), target, stream);
  }
  ...
  if (this->_internal_has_floating_point_objective()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        9, _Internal::floating_point_objective(this), target, stream);
  }
...
void CpModelProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CpModelProto *>(to)->MergeFrom(
      static_cast<const CpModelProto &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.CpModelProto)
  ...
  if (from._internal_has_symmetry()) {
    _internal_mutable_symmetry()->::operations_research::sat::SymmetryProto::MergeFrom(from._internal_symmetry());
  }
  if (from._internal_has_floating_point_objective()) {
    _internal_mutable_floating_point_objective()->::operations_research::sat::FloatObjectiveProto::MergeFrom(from._internal_floating_point_objective());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CpModelProto::InternalSwap(CpModelProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CpModelProto, floating_point_objective_)
...
void CpSolverSolution::ArenaDtor(void* object) {
  CpSolverSolution* _this = reinterpret_cast< CpSolverSolution* >(object);
  (void)_this;
}
void CpSolverSolution::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* CpSolverSolution::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
void CpSolverSolution::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CpSolverSolution *>(to)->MergeFrom(
      static_cast<const CpSolverSolution &>(from));
}


void CpSolverSolution::MergeFrom(const CpSolverSolution& from) {
...
CpSolverResponse::CpSolverResponse(const CpSolverResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      ...
      additional_solutions_(from.additional_solutions_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  solution_info_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    solution_info_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_solution_info().empty()) {
    solution_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_solution_info(), 
      GetArenaForAllocation());
  }
  solve_log_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    solve_log_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_solve_log().empty()) {
    solve_log_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_solve_log(), 
      GetArenaForAllocation());
  }
  if (from._internal_has_integer_objective()) {
    integer_objective_ = new ::operations_research::sat::CpObjectiveProto(*from.integer_objective_);
  } else {
    integer_objective_ = nullptr;
  }
  ::memcpy(&objective_value_, &from.objective_value_,
    static_cast<size_t>(reinterpret_cast<char*>(&inner_objective_lower_bound_) -
    reinterpret_cast<char*>(&objective_value_)) + sizeof(inner_objective_lower_bound_));
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&integer_objective_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&inner_objective_lower_bound_) -
    reinterpret_cast<char*>(&integer_objective_)) + sizeof(inner_objective_lower_bound_));
}
...
inline void CpSolverResponse::SharedDtor() {
  ...
  solve_log_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (this != internal_default_instance()) delete integer_objective_;
}
...
// @@protoc_insertion_point(message_clear_start:operations_research.sat.CpSolverResponse)
  ...
  additional_solutions_.Clear();
  solution_info_.ClearToEmpty();
  solve_log_.ClearToEmpty();
  if (GetArenaForAllocation() == nullptr && integer_objective_ != nullptr) {
    delete integer_objective_;
  }
  integer_objective_ = nullptr;
  ::memset(&objective_value_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&inner_objective_lower_bound_) -
      reinterpret_cast<char*>(&objective_value_)) + sizeof(inner_objective_lower_bound_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 177)) {
          gap_integral_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 25:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 200)) {
          num_lp_iterations_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 26:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 210)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "operations_research.sat.CpSolverResponse.solve_log"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 29:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 232)) {
          inner_objective_lower_bound_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CpSolverResponse::_InternalSerialize(
  ...
  if (raw_gap_integral != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(22, this->_internal_gap_integral(), target);
  }
  ...
  if (this->_internal_num_restarts() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(24, this->_internal_num_restarts(), target);
  }

  // int64 num_lp_iterations = 25;
  if (this->_internal_num_lp_iterations() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(25, this->_internal_num_lp_iterations(), target);
  }
  ...
  // repeated .operations_research.sat.CpSolverSolution additional_solutions = 27;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_additional_solutions_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(27, this->_internal_additional_solutions(i), target, stream);
  }
  ...
  if (this->_internal_has_integer_objective()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        28, _Internal::integer_objective(this), target, stream);
  }

  // int64 inner_objective_lower_bound = 29;
  if (this->_internal_inner_objective_lower_bound() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(29, this->_internal_inner_objective_lower_bound(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:operations_research.sat.CpSolverResponse)
  ...
  for (const auto& msg : this->additional_solutions_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  // int64 num_booleans = 10;
  if (this->_internal_num_booleans() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_num_booleans());
  }

  // int64 num_conflicts = 11;
  if (this->_internal_num_conflicts() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_num_conflicts());
  }
  ...
  // int64 num_binary_propagations = 13;
  if (this->_internal_num_binary_propagations() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_num_binary_propagations());
  }

  // int64 num_integer_propagations = 14;
  if (this->_internal_num_integer_propagations() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_num_integer_propagations());
  }
...
void CpSolverResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<CpSolverResponse *>(to)->MergeFrom(
      static_cast<const CpSolverResponse &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:operations_research.sat.CpSolverResponse)
  ...
  additional_solutions_.MergeFrom(from.additional_solutions_);
  if (!from._internal_solution_info().empty()) {
    _internal_set_solution_info(from._internal_solution_info());
  }
  if (!from._internal_solve_log().empty()) {
    _internal_set_solve_log(from._internal_solve_log());
  }
  if (from._internal_has_integer_objective()) {
    _internal_mutable_integer_objective()->::operations_research::sat::CpObjectiveProto::MergeFrom(from._internal_integer_objective());
  }
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  ...
  memcpy(&raw_gap_integral, &tmp_gap_integral, sizeof(tmp_gap_integral));
  if (raw_gap_integral != 0) {
    _internal_set_gap_integral(from._internal_gap_integral());
  }
  ...
  if (from._internal_num_lp_iterations() != 0) {
    _internal_set_num_lp_iterations(from._internal_num_lp_iterations());
  }
  if (from._internal_inner_objective_lower_bound() != 0) {
    _internal_set_inner_objective_lower_bound(from._internal_inner_objective_lower_bound());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CpSolverResponse::InternalSwap(CpSolverResponse* other) {
  ...
  additional_solutions_.InternalSwap(&other->additional_solutions_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &solution_info_, lhs_arena,
      &other->solution_info_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &solve_log_, lhs_arena,
      &other->solve_log_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CpSolverResponse, inner_objective_lower_bound_)
      + sizeof(CpSolverResponse::inner_objective_lower_bound_)
      - PROTOBUF_FIELD_OFFSET(CpSolverResponse, integer_objective_)>(
          reinterpret_cast<char*>(&integer_objective_),
          reinterpret_cast<char*>(&other->integer_objective_));
}
...
template<> PROTOBUF_NOINLINE ::operations_research::sat::ListOfVariablesProto* Arena::CreateMaybeMessage< ::operations_research::sat::ListOfVariablesProto >(Arena* arena) {
...
template<> PROTOBUF_NOINLINE ::operations_research::sat::FloatObjectiveProto* Arena::CreateMaybeMessage< ::operations_research::sat::FloatObjectiveProto >(Arena* arena) {
...
template<> PROTOBUF_NOINLINE ::operations_research::sat::SparsePermutationProto* Arena::CreateMaybeMessage< ::operations_research::sat::SparsePermutationProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::operations_research::sat::SparsePermutationProto >(arena);
}
template<> PROTOBUF_NOINLINE ::operations_research::sat::DenseMatrixProto* Arena::CreateMaybeMessage< ::operations_research::sat::DenseMatrixProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::operations_research::sat::DenseMatrixProto >(arena);
}
template<> PROTOBUF_NOINLINE ::operations_research::sat::SymmetryProto* Arena::CreateMaybeMessage< ::operations_research::sat::SymmetryProto >(Arena* arena) {
...
template<> PROTOBUF_NOINLINE ::operations_research::sat::CpSolverSolution* Arena::CreateMaybeMessage< ::operations_research::sat::CpSolverSolution >(Arena* arena) {
