...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ortools_2futil_2foptional_5fboolean_2eproto = {
  false, false, 189, descriptor_table_protodef_ortools_2futil_2foptional_5fboolean_2eproto, "ortools/util/optional_boolean.proto", 
  ...
  nullptr, file_level_enum_descriptors_ortools_2futil_2foptional_5fboolean_2eproto, file_level_service_descriptors_ortools_2futil_2foptional_5fboolean_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ortools_2futil_2foptional_5fboolean_2eproto_getter() {
  return &descriptor_table_ortools_2futil_2foptional_5fboolean_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ortools_2futil_2foptional_5fboolean_2eproto(&descriptor_table_ortools_2futil_2foptional_5fboolean_2eproto);
namespace operations_research {
