...
execute_process(
  COMMAND "/usr/bin/git" show-ref "cmake/2.11.6"
  WORKING_DIRECTORY "/home/bouachir/Desktop/GhassenePFE/Implem/or-tools/dependencies/_deps/coinutils-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "cmake/2.11.6")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("cmake/2.11.6" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/cmake/2.11.6")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/bouachir/Desktop/GhassenePFE/Implem/or-tools/dependencies/_deps/coinutils-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/bouachir/Desktop/GhassenePFE/Implem/or-tools/dependencies/_deps/coinutils-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
